<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Games 4 Devs</a>
	<div>
		<form action="<?= base_url('dashboard/shearch') ?>" method="post">
			<input class="form-control form-control-dark" type="text" name="shearch" id="shearch" placeholder="Search" aria-label="Search" value="">
		</form>
	</div>
